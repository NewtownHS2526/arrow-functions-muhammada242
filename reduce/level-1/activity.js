...
EXERCISE 3
----------
Given the array ["apple", "banana", "orange"], use reduce() to
concatenate all strings into one string separated by commas:
"apple,banana,orange".
...
EXERCISE 4
----------
Given the array [5, 15, 25, 35], use reduce() to find the maximum
number.
