...
EXERCISE 2
----------
Given the array [5, 10, 15, 20], use map() to create a new array where
each number is converted to a string with " dollars" added.
...
EXERCISE 3
----------
Given the array ["red", "green", "blue"], use map() to create a new
array where each color is wrapped in HTML tags like "<div>color</div>".
...
each number is multiplied by itself and then added 10.
...
EXERCISE 5
----------
Given the array ["apple", "banana", "cherry"], use map() to create a
new array where each fruit name is reversed (e.g., "apple" becomes
"elppa").
